...
import VpnApp from 'assets/images/vpn-app.png';
import DashboardCowork from 'assets/images/dashboard-cowork.png';
import MusicApp from 'assets/images/music.png';
    ...
    <Styled.Project>
      <ContainerLg>
        ...
        <Styled.Grid>
          <Styled.Box>
            <Styled.Porto>
              <Styled.Link href="https://next-landing-vpn.vercel.app/" target="_blank">
                <Styled.Head>Music App Mobile</Styled.Head>
              </Styled.Link>
              <Styled.SubHead>TailwindCSS Mobile </Styled.SubHead>
              <Styled.Img>
                <img
                  className="transition duration-300 ease-in-out transform hover:-translate-y-6 shadow-lg"
                  src={MusicApp}
                  alt="Music App  Mobile"
                />
              </Styled.Img>
            </Styled.Porto>
          </Styled.Box>
          <Styled.Box>
            <Styled.Porto>
              <Styled.Link href="https://next-landing-vpn.vercel.app/" target="_blank">
                <Styled.Head>VPN Apps Landingpage</Styled.Head>
              </Styled.Link>
          ...
          <Styled.Box>
            <Styled.Porto>
              <Styled.Link href="https://dashboard-cowork.vercel.app/" target="_blank">
                <Styled.Head>Dashboard Co Work Dekstop</Styled.Head>
              </Styled.Link>
              <Styled.SubHead>TailwindCSS + Next.js</Styled.SubHead>
              <Styled.Img>
                <img
          ...
          <Styled.Box>
            <Styled.Porto>
              <Styled.Link href="https://bolder.now.sh/" target="_blank">
                <Styled.Head>Bolder Landingpage</Styled.Head>
              </Styled.Link>
              <Styled.SubHead>TailwindCSS + Next.js</Styled.SubHead>
              <Styled.Img>
                <img
          ...
          <Styled.Box>
            <Styled.Porto>
              <Styled.Link href="https://edmuku-frontend.vercel.app/" target="_blank">
                <Styled.Head>Edmuku Education Management</Styled.Head>
              </Styled.Link>
              ...
              <Styled.Img>
                <img
                  className="transition duration-300 ease-in-out transform hover:-translate-y-6 shadow-lg"
                  src={Edmuku}
                  alt="Edmuku Education Management"
                />
              </Styled.Img>
            </Styled.Porto>
          </Styled.Box>
          <Styled.Box>
            <Styled.Porto>
              <Styled.Link href="https://kerja-mantul.now.sh/" target="_blank">
                <Styled.Head>Kerja Mantul Education Management</Styled.Head>
              </Styled.Link>
              <Styled.SubHead>TailwindCSS + AlpineJS</Styled.SubHead>
              <Styled.Img>
                <img
                  className="transition duration-300 ease-in-out transform hover:-translate-y-6 shadow-lg"
                  src={KerjaMantul}
                  alt="Kerja Mantul Education Management"
                />
              </Styled.Img>
            </Styled.Porto>
          </Styled.Box>
          <Styled.Box>
            <Styled.Porto>
              <Styled.Link href="https://landing-page-belajar-korea.vercel.app/" target="_blank">
                <Styled.Head>BelajarKorea.id Landingpage</Styled.Head>
              </Styled.Link>
              ...
              <Styled.Img>
                <img
                  className="transition duration-300 ease-in-out transform hover:-translate-y-6 shadow-lg"
                  src={BelajarKorea}
                  alt="BelajarKorea.id Landingpage"
                />
              </Styled.Img>
            </Styled.Porto>
          </Styled.Box>
          ...
          <Styled.Box>
            <Styled.Porto>
              <Styled.Link href="http://naufaldi.xyz" target="_blank">
                <Styled.Head>Personal Website</Styled.Head>
              </Styled.Link>
          ...
          <Styled.Box>
            <Styled.Porto>
              <Styled.Link href="https://react-deliv.netlify.app/" target="_blank">
                <Styled.Head>Deliv Ver. Beta Landingpage</Styled.Head>
              </Styled.Link>
              ...
              <Styled.Img>
                <img
                  className="transition duration-300 ease-in-out transform hover:-translate-y-6 shadow-lg"
                  src={Deliv}
                  alt="Deliv Beta Ver Landingpage"
                />
              </Styled.Img>
            </Styled.Porto>
          </Styled.Box>
          <Styled.Box>
            <Styled.Porto>
              <Styled.Link href="http://netflix-cloness.surge.sh/" target="_blank">
                <Styled.Head>Netflix Clone Landingpage</Styled.Head>
              </Styled.Link>
          ...
          <Styled.Box>
            <Styled.Porto>
              <Styled.Link href="http://landing-chal.surge.sh/" target="_blank">
                <Styled.Head>Huddle Landingpage</Styled.Head>
              </Styled.Link>
              <Styled.SubHead>Plain CSS</Styled.SubHead>
              <Styled.Img>
                <img
          ...
          <Styled.Box>
            <Styled.Porto>
              <Styled.Link href="https://landing-page-belajar-korea.vercel.app/" target="_blank">
                <Styled.Head>Rumah Pekerja Indonesia Landingpage</Styled.Head>
              </Styled.Link>
              ...
              <Styled.Img>
                <img
                  className="transition duration-300 ease-in-out transform hover:-translate-y-6 shadow-lg"
                  src={RumahPekerja}
                  alt="Rumah Pekerja Indonesia Landingpage"
                />
              </Styled.Img>
            </Styled.Porto>
          </Styled.Box>
          <Styled.Box>
            <Styled.Porto>
              <Styled.Link href="https://ksaja-nextjs-msfjvrftg.now.sh/" target="_blank">
                <Styled.Head>KSaja Web News</Styled.Head>
              </Styled.Link>
          ...
          <Styled.Box>
            <Styled.Porto>
              <Styled.Link href="https://shinhan-bank-mbqnm1yup.now.sh/home.html" target="_blank">
                <Styled.Head>Shihan Course Manajemen</Styled.Head>
              </Styled.Link>
              <Styled.SubHead>TailwindCSS + AlpineJS</Styled.SubHead>
              <Styled.Img>
                <img
